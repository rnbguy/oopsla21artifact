...
//    public static final int DISTANCES[] = { 5, 10, 25, 50, 100 };
    ...
    public static final int FLIGHTS_DAYS_FUTURE = 1; // 50;
     ...
     */
    public static final int FLIGHTS_NUM_SEATS = 5; // 150;
    
    /**
     * How many First Class seats are on a given flight
     * These reservations are more expensive
     */
    public static final int FLIGHTS_FIRST_CLASS_OFFSET = 2; // 10;
     ...
     */
    public static final int CUSTOMERS_COUNT = 5; // 100000;
