...
#ifndef NEKARA_KEY_VALUE_STORE_CONSISTENCY_CHECKER_H
#define NEKARA_KEY_VALUE_STORE_CONSISTENCY_CHECKER_H
...
#endif //NEKARA_KEY_VALUE_STORE_CONSISTENCY_CHECKER_H
